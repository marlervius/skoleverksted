...
If you see **RESOURCE_EXHAUSTED** or **quota exceeded** for `gemini-3.8-flash`:
...
- **Model:** use `gemini-3.8-flash`, or `gemini-3.1-flash-lite` when lower cost is more important (check [rate limits](https://ai.google.dev/gemini-api/docs/rate-limits)).
